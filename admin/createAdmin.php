  ...
  <section id="container">
    ...
    <div class="container">
      <ul class="ht-breadcrumbs ht-breadcrumbs--y-padding ht-breadcrumbs--b-border">
        ...
        <li class="ht-breadcrumbs__item"><span class="ht-breadcrumbs__page"> Create Admin</span></li>
      </ul><!-- .ht-breadcrumb -->
        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <div class="settings-block">
              ...
              <ul class="settings">
                <li class="setting "><a href="viewUploads.php" class="setting__link">
                    <ion-icon name="eye" class="setting__icon"></ion-icon>View Uploaded Hostels
                  </a></li>
                <li class="setting "><a href="Unapprove.php" class="setting__link">
                    <ion-icon name="close-circle" class="setting__icon"></ion-icon>View Unapproved Hostels
                  </a></li>
                <li class="setting "><a href="userFeedback.php" class="setting__link">
                    <ion-icon name="mail-unread" class="setting__icon"></ion-icon>Users Feedback
                  </a></li>
            ...
            <div class="settings-block">
              <ul class="settings">
                ...
                <li class="setting"><a href="createAdmin.php" class="setting__link">
                    <ion-icon name="create" class="setting__icon"></ion-icon>Create Admin
                  </a></li>
                <form action="dashboard.php" method="post">
                  <li><input type="submit" value="Logout" name="logout" class="logout" style="background-color: red; color:aliceblue"></li>
                </form>
          ...
          <form method="post" enctype="multipart/form-data" action="createAdmin.php">
            <div class="col-md-4">
              ...
              <input type="text" name="fname" required="required" class="form-control"><br>

              <label for="profile-first-name" class="my-profile__label">Last Name</label>

              <input type="text" name="lname" required="required" class="form-control"><br>
            ...
            <div class="col-md-5">
              ...
              <input type="number" name="phone_no" required="required" class="form-control" onkeypress="if(this.value.length==12)return false;"><br>


              <label for="profile-password" class="my-profile__label">New Password</label>

              <input type="password" name="newpassword" required="required" class="form-control"><br>
              <input type="submit" name="submit_admin" class="my-profile__submit" value="Submit">
            </div>
