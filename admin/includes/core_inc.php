        ...
        <li class="manage-list__item">
            <div class="manage-list__item-container">
                ...
                <div class="manage-list__item-detail">
                    ...
                    <p class="listing_price">
                        <ion-icon name="warning-outline"></ion-icon>Rules <?php echo $row['rules'] ?>
                    </p>
                    <p class="listing_price">
                        <ion-icon name="pricetag-outline"></ion-icon>Hostel Type <?php echo $row['hos_type'] ?>
                    </p>
                    <p class="listing_price">
                        <ion-icon name="cafe-outline"></ion-icon>Services: <?php echo $row['services'] ?>
                    </p>
                </div>
            </div>
            ...
            <div class="manage-list__action">
                ...
                <a href="includes/approve_hostel.php?status=<?php echo $row['ID'] ?>" class="btn btn-success btn-sm">
...
{
    require 'config.php';
    $query = "SELECT * from `feedback` where `ischecked`='pending' ";
    $query_run = mysqli_query($con, $query);
    $check_row = mysqli_num_rows($query_run);
    $i = 1;
    if ($check_row > 0) {
        while ($row = mysqli_fetch_assoc($query_run)) {
?>
            ...
            <tr>
                ...
                <td class="manage-list__item-img" style="text-align: center;">
                    <a href="includes/approve_hostel.php?check=<?php echo $row['ID'] ?>" id="checked_btn">
        ...
        ?>
        <h1 style="color:red; text-transform:uppercase">No feedback</h1>
