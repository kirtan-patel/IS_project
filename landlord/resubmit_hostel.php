...
<header class="header header--blue">
 ...
 <div class="container">
    <ul class="ht-breadcrumbs ht-breadcrumbs--y-padding ht-breadcrumbs--b-border">
      ...
      <li class="ht-breadcrumbs__item"><span class="ht-breadcrumbs__page">Resubmit Hostel</span></li>
    </ul><!-- .ht-breadcrumb -->
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="settings-block">
            ...
            <ul class="settings">
              <li class="setting"><a href="my_hostel.php" class="setting__link"><ion-icon name="lock-open" class="setting__icon"></ion-icon>My Hostel</a></li>
